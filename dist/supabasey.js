 ...
 */
let coreSupabasey = function Supabasey(cb, options) {
    // Sanity checks
    ...
    return Promise.resolve()
        .then(() => pRetry(() => cb.call(supabaseClient, supabaseClient), {
...
supabasey.init = function supabaseyInit(options) {
    ...
    let sessionKey = settings.session == 'auto' && env.SUPABASE_URL ? env.SUPABASE_URL
